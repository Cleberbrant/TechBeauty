...
namespace TechBeauty.Dados.Repositorio
{
    ...
    {
        public List<Colaborador> TabelaColaborador { get; set; } = new List<Colaborador>();

        public ColaboradorRepositorio(List<Contato> contato, List<Servico> servico, List<Endereco> endereco, List<Genero> genero, List<ContratoTrabalho> contrato)
        {
            PreencherDados(contato, servico, endereco, genero, contrato);
        }
        ...
        Endereco endereco, Genero genero, string NomeSocial, ContratoTrabalho contrato)
        {
            TabelaColaborador.FirstOrDefault(x => x.Id == id).Alterar(nome, cpf, dataNascimento, contatos, servicos, endereco, genero, contrato, NomeSocial);
        }
